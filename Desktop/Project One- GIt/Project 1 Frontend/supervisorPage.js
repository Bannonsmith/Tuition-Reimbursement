...
async function updateApproval(id){
   ...
   //console.log("s:", svote, st, sd);
    ...
    //Since it already stored in the session you dont need this
    //call but if session was restricted then you can go ahead 
    //and make the calls and set the value to updatedData
    // const url = `http://localhost:7001/approval/${id}`;
    ...
    const updatedData = {
        ...
        approvalBenco: bvote,
        approvalFinal: ovote,
        approvalAmount: updatedAmount,
        supervisorsDescription: sd,
        supervisorsTime: st,
        departmentHeadDescription: dd,
        departmentHeadTime: dt,
        bencoDescription: bd,
        bencoTime: bt,
        approvalEmployeeId: {
